...
import static org.cocos2d.utils.BufferProvider.createFloatBuffer;
...
public class CCSprite extends CCNode implements CCRGBAProtocol, CCTextureProtocol {
    ...
    */
    ...
    private FloatBuffer texCoords = (FloatBuffer) org.cocos2d.utils.BufferProvider.createFloatBuffer(4 * 2);
    public float[] getTexCoordsArray() {
    	float ret[] = new float[texCoords.limit()];
    	texCoords.get(ret, 0, texCoords.limit());
    	return ret;
    }
    private FloatBuffer vertexes = (FloatBuffer) org.cocos2d.utils.BufferProvider.createFloatBuffer(4 * 3);
    ...
    private FloatBuffer colors = (FloatBuffer) org.cocos2d.utils.BufferProvider.createFloatBuffer(4 * 4);
